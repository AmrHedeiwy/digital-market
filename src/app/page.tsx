...
const perks = [
  {
    ...
    desciption:
      'Get your assets delivred to your email in seconds and download them right away.'
  },
  {
  ...
  return (
    <>
      <MaxWidthWrapper>
        ...
        <ProductReel query={{ sort: 'desc' }} href="/products" title="Brand new" />
      </MaxWidthWrapper>
