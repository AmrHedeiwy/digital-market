        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    filteredProducts = products.filter(function (product) { return !!product.priceId; });
                ...
                case 3:
                    ...
                    line_items.push({
                        price: 'price_1P6vnS2LjyjFMFLmdiYbCco4',
                        quantity: 1,
                ...
                case 6:
                    err_1 = _c.sent();
                    payload.logger.info(err_1, 'STRIPE CREATE SESSION');
