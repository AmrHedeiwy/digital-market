...
var weebhooks_1 = require("./weebhooks");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                app.post('/api/webhooks/stripe', webhookMiddleware, weebhooks_1.stripeWebhookHandler);
            ...
            case 1:
                ...
                cartRouter.get('/', function (req, res) {
                    ...
                    var parsedUrl = (0, url_1.parse)(request.url, true);
                ...
                next_utils_1.nextApp.prepare().then(function () {
                    ...
                    app.listen(PORT, function () { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            payload.logger.info("Next.s App URL: ".concat(process.env.NEXT_PUBLIC_SERVER_URL));
                            return [2 /*return*/];
                        });
                    }); });
                });
