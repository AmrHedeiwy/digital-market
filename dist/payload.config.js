...
exports.default = (0, config_1.buildConfig)({
    ...
    collections: [Users_1.default, Products_1.Products, ProductFile_1.ProductFiles, Media_1.Media, Orders_1.Orders],
    routes: { admin: '/sell' },
    admin: {
        user: 'users',
        bundler: (0, bundler_webpack_1.webpackBundler)(),
        meta: {
            titleSuffix: '- DigitalArk',
            favicon: '/favicon.ico',
    ...
    typescript: { outputFile: path_1.default.resolve(__dirname, 'payload-types.ts') }
});
