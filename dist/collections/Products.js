...
var syncUser = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var fullUser, products, allIDs, dataToUpdate;
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                dataToUpdate = __spreadArray(__spreadArray([], allIDs, true), [doc.id], false);
...
var isAdminOrHasAccessToProduct = function (_a) {
    var req = _a.req;
    var user = req.user;
    if (!user)
        return false;
...
exports.Products = {
    ...
    access: {
        read: isAdminOrHasAccessToProduct
    },
    hooks: {
        ...
        beforeChange: [
            ...
            function (args) { return __awaiter(void 0, void 0, void 0, function () {
                var data, createdProduct, data, updatedProduct;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, __assign(__assign({}, data), { stripeId: createdProduct.id, priceId: createdProduct.default_price })];
                        case 2:
                        ...
                        case 3:
                            ...
                            return [2 /*return*/, __assign(__assign({}, data), { stripeId: updatedProduct.id, priceId: updatedProduct.default_price })];
