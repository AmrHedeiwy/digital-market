    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                purchasedProductFileIds = orders
                    ...
                    return order.products.map(function (product) {
                        if (typeof product === 'string')
                            return req.payload.logger.error('Search depth no sufficient to find purchased file IDs');
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], ownProductFileIds, true), [purchasedProductFileIds], false)
                        }
                    }];
        }
    });
